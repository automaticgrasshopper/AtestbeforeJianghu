...
Yanfly.Param.BCEList = {
  ...
  // enter: Number(Yanfly.Parameters['Key Enter (OK)']),//edit SRD compatible
...
// if (Yanfly.Param.BCEList['enter'] !== 0) Input.keyMapper[13] = 'enter';//edit SRD compatible
...
Input._revertButton = function (button) {
  if (button === 'OK') {
    //this.keyMapper[13] = 'ok'; //edit SRD compatible
...
Input._switchButton = function (button) {
  if (button === 'OK') {
    // if (Yanfly.Param.BCEList['enter'] !== 0) this.keyMapper[13] = 'enter';//edit SRD compatible
